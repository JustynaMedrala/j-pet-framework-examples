...
public:  
  ...
  static bool checkForScatter_minimalDifference(const JPetEvent& event, JPetStatistics& stats, 
                                                bool saveHistos, double scatterTOFTimeDiff, std::string fTOTCalculationType, 
                                                std::vector<bool> fHitInfo);
  static bool checkForAccidental(const JPetEvent& event, JPetStatistics& stats, bool saveHistos, 
			      std::vector<unsigned int> fHitInfo);
  ...
  static bool findVertex(const JPetHit& hit1, const JPetHit& hit2, const JPetHit& hit3, JPetStatistics& stats);
