...
protected:
  ...
  double f3gTimeDiff = 2000.0;
  double f3gMinRelAngle = 185.0;
  double fToTCutAnniMin = 5000000.0;
  double fToTCutAnniMax = 7700000.0;
  ...
  double fToTCut3AnniMin = 3500000.0;
  double fToTCut3AnniMax = 7500000.0;
