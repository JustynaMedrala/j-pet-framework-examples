...
*/
      bool isLifetime2Gamma_good = EventCategorizerTools::checkFor2GammaLifetime(
...
*/
      bool isLifetime3Gamma_good = EventCategorizerTools::checkFor3GammaLifetime(
          event, bad_ID, f3gMinRelAngle, f3gTimeDiff, f3gDOP, getStatistics(), fSaveControlHistos, fToTCut3AnniMin, fToTCut3AnniMax, fToTCutDeexMin, fToTCutDeexMax, fSourcePos, fTestType, 
...
void EventCategorizer::initialiseHistograms()
{
  ...
  getStatistics().createHistogramWithAxes(new TH1D("stats_2gamma_masking", "Categories of events", 2, 0.5, 2.5), " ", "Number of events");
  binLabels = {make_pair(1, "All"), make_pair(2, "With masking")};
  getStatistics().setHistogramBinLabel("stats_2gamma_masking", getStatistics().AxisLabel::kXaxis, binLabels);

  getStatistics().createHistogramWithAxes(new TH1D("stats_3gamma_masking", "Categories of events", 2, 0.5, 2.5), " ", "Number of events");
  binLabels = {make_pair(1, "All"), make_pair(2, "With masking")};
  getStatistics().setHistogramBinLabel("stats_2gamma_masking", getStatistics().AxisLabel::kXaxis, binLabels);
  ...
  getStatistics().createHistogramWithAxes(new TH1D("2g_stats_multi_prompt", "Number of prompts in event", 10, -0.5, 9.5),
                                          "Number of prompts", "Multiplicity");

  getStatistics().createHistogramWithAxes(new TH1D("2g_stats_multi_annihilations", "Number of annihilations in event", 10, -0.5, 9.5),
                                          "Number of annihilations", "Multiplicity");

  getStatistics().createHistogramWithAxes(new TH1D("2g_stats_multi", "Number of hits in event", 20, -0.5, 19.5),
                                          "Number of hits", "Multiplicity");

  getStatistics().createHistogramWithAxes(new TH2D("2g_hit_multi_scin", "Number of signals from SiPMs in created hit per Scin",
                                                   maxScinID - minScinID + 1, minScinID - 0.5, maxScinID + 0.5, 12, -0.5, 11.5),
                                          "Scintillator ID", "Signal multiplicity [ps]");

  getStatistics().createHistogramWithAxes(new TH2D("theta_2g_hit_multi_scin", "Number of signals from SiPMs in created hit per Scin",
                                                   maxScinID - minScinID + 1, minScinID - 0.5, maxScinID + 0.5, 12, -0.5, 11.5),
                                          "Scintillator ID", "Signal multiplicity [ps]");

  getStatistics().createHistogramWithAxes(new TH1D("2g_tot_all", "2 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");
  ...
  getStatistics().createHistogramWithAxes(new TH1D("2g_scatter_test_dist", "Scatter Test - Distance Difference", 201, -120.0, 120.0),
  ...
  //After tot cut
  getStatistics().createHistogramWithAxes(new TH1D("tot_2g_tot", "2 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("tot_2g_theta", "2 gamma event - flight vectors theta", 181, -0.5, 180.5), "Angle [degree]",
                                          "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(
      new TH1D("tot_2g_timeDiff", "Time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff),
      "Time  Difference between annihilation hits [ps]", "Number of Hit Pairs");
  
  // After scatter cut
  getStatistics().createHistogramWithAxes(
      new TH1D("scatter_2g_tot", "2 gamma event after theta cut - average ToT scaled", 201, 0.0, fToTHistoUpperLimit), "Time over Threshold [ps]",
      "Number of Hit Pairs");
  ...
  getStatistics().createHistogramWithAxes(new TH1D("scatter_2g_scatter_test_dist", "Scatter Test - Distance Difference", 201, -120.0, 120.0),
                                          "Dist Diff [cm]", "Number of Hit Pairs");
  ...
  // After tDiff cut
  getStatistics().createHistogramWithAxes(
      new TH1D("tdiff_2g_tot", "2 gamma event after theta cut - average ToT scaled", 201, 0.0, fToTHistoUpperLimit), "Time over Threshold [ps]",
      "Number of Hit Pairs");
  ...
  // After theta cut
    getStatistics().createHistogramWithAxes(
      new TH1D("theta_2g_tot", "2 gamma event after theta cut - average ToT scaled", 201, 0.0, fToTHistoUpperLimit), "Time over Threshold [ps]",
      "Number of Hit Pairs");
  ...
  getStatistics().createHistogramWithAxes(new TH1D("ap_2g_stats_events",  "Number of events classified as back-to-back annihilations", 10, -0.5, 9.5),
                                          "Number of events", "Multiplicity");

  getStatistics().createHistogramWithAxes(new TH1D("ap_2g_tot", "Annihilation pairs average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
  ...
  //Histograms for 2gamma + 1 prompt category
    getStatistics().createHistogramWithAxes(new TH1D("none_2g_tot_lifetime", "2 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");

    getStatistics().createHistogramWithAxes(new TH1D("2g_tot_lifetime", "2 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");

    getStatistics().createHistogramWithAxes(new TH1D("2g_ID_all_lifetime", "ID of all hits", 314, 199.5, 513.5),
                                           "ID", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("2g_theta_lifetime", "2 gamma event - flight vectors theta", 181, -0.5, 180.5), "Angle [degree]",
                                          "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(
      new TH2D("2g_timeDiff_theta_lifetime", "Time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff, 181, -0.5, 180.5),
      "Time  Difference between annihilation hits [ps]", "Angle [degree]");

  getStatistics().createHistogramWithAxes(new TH1D("2g_DOP_lifetime", "2 gamma event - distance between source and the reconstructed annihilation point", 40, 0.0,20.0),
                                          "Distance [cm]", "Number of Hits");

  getStatistics().createHistogramWithAxes(
      new TH1D("2g_timeDiff_lifetime", "Time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff),
      "Time  Difference between annihilation hits [ps]", "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(
      new TH1D("2g_masking_timeDiff_lifetime", "Time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff),
      "Time  Difference between annihilation hits [ps]", "Number of Hit Pairs");

    getStatistics().createHistogramWithAxes(
      new TH2D("2g_masking_timeDiff_ID_lifetime", "Time difference between hits", maxScinID - minScinID + 1, minScinID - 0.5, maxScinID + 0.5, 201, -fMaxTimeDiff, fMaxTimeDiff),
      "ScinID", "Time  Difference between annihilation hits [ps]");

  getStatistics().createHistogramWithAxes(new TH2D("2g_time_annih_12_lifetime", "Time of registration", 500, 0, 5e7, 500, 0, 5e7),
                                          "annih_1 registration time [ps]", "annih_2 registration time [ps]");

  getStatistics().createHistogramWithAxes(new TH2D("2g_time_hit_12_lifetime", "Time of registration", 500, 0, 5e7, 500, 0, 5e7),
                                          "time of the first hit in the event [ps]", "time of the second hit in the event [ps]");

    getStatistics().createHistogramWithAxes(new TH1D("2g_ID_peak_lifetime", "ID of hits in time difference range [3.5, 5] ns", 314, 199.5, 513.5),
                                          "ID", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH2D("2g_xy_peak_lifetime", "XY position of hits (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "X position [cm]", "Y position [cm]");

  getStatistics().createHistogramWithAxes(new TH2D("2g_time_annih_12_peak_lifetime", "Time of registration", 500, 0, 5e7, 500, 0, 5e7),
                                          "annih_1 registration time [ps]", "annih_2 registration time [ps]");

  getStatistics().createHistogramWithAxes(new TH2D("2g_zx_peak_lifetime", "ZX position of hits (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "Z position [cm]", "X position [cm]");

  getStatistics().createHistogramWithAxes(new TH2D("2g_xy_source_peak_lifetime", "XY position of annihilation point (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "X position [cm]", "Y position [cm]");

  getStatistics().createHistogramWithAxes(new TH2D("2g_zx_source_peak_lifetime", "ZX position of annihilation point (bin 0.5 cm)",242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "Z position [cm]", "X position [cm]");

    getStatistics().createHistogramWithAxes(new TH1D("2g_ID_remain_lifetime", "ID of all hits", 314, 199.5, 513.5),
                                           "ID", "Number of Hits");

  getStatistics().createHistogramWithAxes(
      new TH1D("scatter_2g_tot_lifetime", "2 gamma event after theta cut - average ToT scaled", 201, 0.0, fToTHistoUpperLimit), "Time over Threshold [ps]",
      "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(new TH1D("scatter_2g_theta_lifetime", "2 gamma event after ToT cut - theta between flight vectors", 181, -0.5, 180.5),
                                          "Angle [degree]", "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(
      new TH1D("scatter_2g_timeDiff_lifetime", "Time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff),
      "Time  Difference between annihilation hits [ps]", "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(new TH2D("scatter_2g_xy_peak_lifetime", "XY position of hits (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "X position [cm]", "Y position [cm]");

  getStatistics().createHistogramWithAxes(new TH2D("scatter_2g_zx_peak_lifetime", "ZX position of hits (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "Z position [cm]", "X position [cm]");

  getStatistics().createHistogramWithAxes(new TH2D("scatter_2g_xy_source_peak_lifetime", "XY position of annihilation point (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "X position [cm]", "Y position [cm]");

  getStatistics().createHistogramWithAxes(new TH2D("scatter_2g_zx_source_peak_lifetime", "ZX position of annihilation point (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "Z position [cm]", "X position [cm]");

  getStatistics().createHistogramWithAxes(
      new TH1D("tdiff_2g_tot_lifetime", "2 gamma event after theta cut - average ToT scaled", 201, 0.0, fToTHistoUpperLimit), "Time over Threshold [ps]",
      "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(new TH1D("tdiff_2g_theta_lifetime", "2 gamma event after ToT cut - theta between flight vectors", 181, -0.5, 180.5),
                                          "Angle [degree]", "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(
      new TH1D("tdiff_2g_timeDiff_lifetime", "Time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff),
      "Time  Difference between annihilation hits [ps]", "Number of Hit Pairs");

    getStatistics().createHistogramWithAxes(
      new TH1D("theta_2g_tot_lifetime", "2 gamma event after theta cut - average ToT scaled", 201, 0.0, fToTHistoUpperLimit), "Time over Threshold [ps]",
      "Number of Hit Pairs");

    getStatistics().createHistogramWithAxes(new TH1D("theta_2g_ID_all_lifetime", "ID of all hits", 314, 199.5, 513.5),
                                           "ID", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("theta_2g_theta_lifetime", "2 gamma event after ToT cut - theta between flight vectors", 181, -0.5, 180.5),
                                          "Angle [degree]", "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(
      new TH2D("theta_2g_timeDiff_theta_lifetime", "Time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff, 181, -0.5, 180.5),
      "Time  Difference between annihilation hits [ps]", "Angle [degree]");

  getStatistics().createHistogramWithAxes(
      new TH1D("theta_2g_timeDiff_lifetime", "Time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff),
      "Time  Difference between annihilation hits [ps]", "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(new TH2D("theta_2g_time_annih_12_lifetime", "Time of registration", 500, 0, 5e7, 500, 0, 5e7),
                                          "t1 [ps]", "t2 [ps]");

    getStatistics().createHistogramWithAxes(new TH1D("theta_2g_ID_peak_lifetime", "ID of hits in time difference range [3.5, 5] ns", 314, 199.5, 513.5),
                                           "ID", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH2D("theta_2g_xy_first_peak_lifetime", "XY position of hits (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "X position [cm]", "Y position [cm]");

  getStatistics().createHistogramWithAxes(new TH2D("theta_2g_xy_second_peak_lifetime", "XY position of hits (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "X position [cm]", "Y position [cm]");

  getStatistics().createHistogramWithAxes(new TH2D("theta_2g_zx_first_peak_lifetime", "ZX position of hits (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "Z position [cm]", "X position [cm]");

  getStatistics().createHistogramWithAxes(new TH2D("theta_2g_zx_second_peak_lifetime", "ZX position of hits (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "Z position [cm]", "X position [cm]");

  getStatistics().createHistogramWithAxes(new TH2D("theta_2g_xy_source_peak_lifetime", "XY position of annihilation point (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "X position [cm]", "Y position [cm]");

  getStatistics().createHistogramWithAxes(new TH2D("theta_2g_zx_source_peak_lifetime", "ZX position of annihilation point (bin 0.5 cm)", 242, -60.5, 60.5, 242, -60.5, 60.5),
                                          "Z position [cm]", "X position [cm]");

    getStatistics().createHistogramWithAxes(
      new TH1D("ap_2g_tot_lifetime", "2 gamma event after theta cut - average ToT scaled", 201, 0.0, fToTHistoUpperLimit), "Time over Threshold [ps]",
      "Number of Hit Pairs");
  ...
  getStatistics().createHistogramWithAxes(new TH1D("2g_scatter_test_time_lifetime", "Scatter Test - Time Difference", 401, -10000.0, 10000.0),
                                          "annih1 - annih2, tDiff - d/c [ps]", "Number of pairs");
  

  getStatistics().createHistogramWithAxes(new TH1D("scatter_2g_scatter_test_time_lifetime", "Scatter Test - Time Difference", 401, -10000.0, 10000.0),
                                          "annih1 - annih2, tDiff - d/c [ps]", "Number of pairs");


  getStatistics().createHistogramWithAxes(new TH1D("tdiff_2g_scatter_test_time_lifetime", "Scatter Test - Time Difference", 401, -10000.0, 10000.0),
                                          "annih1 - annih2, tDiff - d/c [ps]", "Number of pairs");

  getStatistics().createHistogramWithAxes(new TH1D("theta_2g_scatter_test_time_lifetime", "Scatter Test - Time Difference", 401, -10000.0, 10000.0),
                                          "annih1 - annih2, tDiff - d/c [ps]", "Number of pairs");
  ...
  getStatistics().createHistogramWithAxes(new TH1D("3g_tot_all", "3 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("3g_tot", "3 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");


  getStatistics().createHistogramWithAxes(new TH1D("tot_3g_tot", "3 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("tdiff_3g_tot", "3 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("theta_3g_tot", "3 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("ap_3g_tot", "3 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");
  ...
  getStatistics().createHistogramWithAxes(new TH1D("3g_tot_lifetime", "3 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("DOP_3g_tot_lifetime", "3 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("tdiff_3g_tot_lifetime", "3 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("theta_3g_tot_lifetime", "3 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("ap_3g_stats_events", "Number of events classified as o-Ps", 10, -0.5, 9.5),
                                          "Number of events", "Multiplicity");

  getStatistics().createHistogramWithAxes(new TH1D("ap_3g_tot_lifetime", "3 gamma event - average ToT scaled", 201, 0.0, fToTHistoUpperLimit),
                                          "Time over Threshold [ps]", "Number of Hits");


  getStatistics().createHistogramWithAxes(new TH1D("3g_DOP_lifetime", "3 gamma event - distance between source and the plane", 40, 0.0,20.0),
                                          "Distance [cm]", "Number of Hits");

  getStatistics().createHistogramWithAxes(new TH1D("DOP_3g_DOP_lifetime", "3 gamma event - distance between source and the plane", 40, 0.0,20.0),
                                          "Distance [cm]", "Number of Hits");
  ...
  getStatistics().createHistogramWithAxes(
      new TH1D("3g_timeDiff_lifetime", "Maximal time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff),
      "Time  Difference between annihilation hits [ps]", "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(
      new TH1D("DOP_3g_timeDiff_lifetime", "Maximal time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff),
      "Time  Difference between annihilation hits [ps]", "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(
      new TH1D("tdiff_3g_timeDiff_lifetime", "Maximal time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff),
      "Time  Difference between annihilation hits [ps]", "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(
      new TH1D("theta_3g_timeDiff_lifetime", "Maximal time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff),
      "Time  Difference between annihilation hits [ps]", "Number of Hit Pairs");

  getStatistics().createHistogramWithAxes(
      new TH1D("ap_3g_timeDiff_lifetime", "Maximal time difference between hits", 201, -fMaxTimeDiff, fMaxTimeDiff),
      "Time  Difference between annihilation hits [ps]", "Number of Hit Pairs");
  ...
  getStatistics().createHistogramWithAxes(new TH1D("lifetime_ap_2g_masking_prompt", "Time difference of 2 gamma pair decay time and prompt emmission time", 201,
                                          -1.5 * fEventTimeWindow, 1.5*fEventTimeWindow), "Time Diff [ps]", "Number of events"); 

  getStatistics().createHistogramWithAxes(new TH1D("lifetime_ap_2g_masking_prompt_zoom", "Time difference of 2 gamma pair decay time and prompt emmission time", 201,
                                          -1*fEventTimeWindow_zoom, 10*fEventTimeWindow_zoom), "Time Diff [ps]", "Number of events"); 
