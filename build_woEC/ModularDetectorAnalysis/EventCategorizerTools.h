...
public:
  ...
  static bool checkFor2GammaLifetime_exactly_3hits(const JPetEvent& event, std::vector<int> bad_ID, JPetStatistics& stats, bool saveHistos, double maxThetaDiff, double maxTimeDiff,
                                     double totCutAnniMin, double totCutAnniMax, double totCutDeexMin, double totCutDeexMax,
                                     const TVector3& sourcePos, ScatterTestType testType, double scatterTestValue, double scatterTimeMin,
                                     double scatterTimeMax, double scatterAngleMin, double scatterAngleMax);

  static bool checkFor2GammaLifetime(const JPetEvent& event, JPetStatistics& stats, bool saveHistos, double maxThetaDiff,
  ...
  static bool checkFor3GammaLifetime(const JPetEvent& event, double minRelAngleCut, double maxTimeDiff, JPetStatistics& stats, bool saveHistos, double totCutAnniMin, 
                            double totCutAnniMax, double totCutDeexMin, double totCutDeexMax, ScatterTestType testType, double scatterTestValue,
                            double scatterTimeMin, double scatterTimeMax, double scatterAngleMin, double scatterAngleMax);

  static bool checkFor3GammaLifetime(const JPetEvent& event, std::vector<int> bad_ID, double minRelAngleCut, double maxTimeDiff, double maxDOP, JPetStatistics& stats, 
